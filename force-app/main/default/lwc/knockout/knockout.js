...
export default class Knockout extends LightningElement {
    @api recordId;
    ...
    @wire(getGameResultsByCompetitionFirstRound, { matchId: '$recordId' })
    ...
    @wire(getGameResultsByCompetitionSecondRound, { matchId: '$recordId' })
    ...
    @wire(getGameResultsByCompetitionSemiFinals, { matchId: '$recordId' })
    ...
    @wire(getGameResultsByCompetitionPlacementGame, { matchId: '$recordId' })
    ...
    @wire(getGameResultsByCompetitionFinals, { matchId: '$recordId' })
    ...
    updateRoundOf16Matches(data) {
        ...
        if (roundOf16) { 
            roundOf16.matches = data.map(match => ({
                id: match.Id,
                ...
                imageUrl1: `/resource/${match.Team1__r.Team_Logo__c}`,
                imageUrl2: `/resource/${match.Team2__r.Team_Logo__c}`,
                hadPenalty: match.Home_Team_Penalty__c != null || match.Away_Team_Penalties__c != null// Check if either penalty is not null
    ...
    updateRoundOf8Matches(data) {
        ...
        if (roundOf8) {
            roundOf8.matches = data.map(match => ({
                id: match.Id,
                team1: match.Team1__r.Name,
                score1: match.Team1_Goals__c,
                penalty1: match.Home_Team_Penalty__c,
    ...
    updateRoundOf4Matches(data) {
        ...
        if (roundOf4) {
            roundOf4.matches = data.map(match => ({
                id: match.Id,
                team1: match.Team1__r.Name,
                score1: match.Team1_Goals__c,
                penalty1: match.Home_Team_Penalty__c,
    ...
    updateRoundOfplacementGameMatches(data) {
        ...
        if (placementGame) {
            placementGame.matches = data.map(match => ({
                id: match.Id,
                team1: match.Team1__r.Name,
                score1: match.Team1_Goals__c,
                penalty1: match.Home_Team_Penalty__c,
